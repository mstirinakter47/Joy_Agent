                ...
                children: [
                  ...
                  Container(
                    child: Column(children: [
                      ...
                      CustomInkWell(
                        child: widget.MenuItem(image: Images.with_draw,title: 'withdraw_history'.tr),
                      ...
                      GetBuilder<ProfileController>(builder: (profileController){
                        return Container(
                          ...
                          child: Row( children: [
                            ...
                            Text(
                              'dark_mode'.tr,style: rubikRegular.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE),
                            ),
                            Spacer(),
                  ...
                  Column( children: [
                    CustomInkWell(child: widget.MenuItem(image: Images.log_out,title: 'logout'.tr), onTap:() => Get.find<ProfileController>().logOut()),
