        ...
        child: Row(children: [
          ...
          GetBuilder<AuthController>(builder: (authController) {
            return GetBuilder<ProfileController>(builder: (profController) {
              print('bio-status : ${(authController.biometric && authController.biometricPin() != null && authController.bioList.isNotEmpty)}');
              bool _isOn = isAuth ?
              (authController.biometric && authController.biometricPin() != null && authController.bioList.isNotEmpty) : profController.userInfo.twoFactor;
